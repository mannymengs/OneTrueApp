...
#import "JuniorHockView.h"

@interface JuniorHockView ()

@end

@implementation JuniorHockView
@synthesize webview;
 ...
 */
- (void)viewDidLoad {
    NSString *website = @"http://www.roxburylatin.org/school_life/athteampages.aspx?TeamID=685";
