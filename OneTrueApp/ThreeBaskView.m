...
#import "ThreeBaskView.h"

@interface ThreeBaskView ()

@end

@implementation ThreeBaskView
@synthesize webview;
 ...
 */
- (void)viewDidLoad {
    NSString *website = @"http://www.roxburylatin.org/school_life/athteampages.aspx?TeamID=674";
