...
#import "JuniorWrestView.h"

@interface JuniorWrestView ()

@end

@implementation JuniorWrestView
@synthesize webview;
 ...
 */
- (void)viewDidLoad {
    NSString *website = @"http://www.roxburylatin.org/school_life/athteampages.aspx?TeamID=701";
