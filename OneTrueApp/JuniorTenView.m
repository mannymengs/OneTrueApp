...
#import "JuniorTenView.h"

@interface JuniorTenView ()

@end

@implementation JuniorTenView
@synthesize webview;
 ...
 */
- (void)viewDidLoad {
    NSString *website = @"http://www.roxburylatin.org/school_life/athteampages.aspx?TeamID=697";
