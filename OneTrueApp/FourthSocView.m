...
#import "FourthSocView.h"

@interface FourthSocView ()

@end

@implementation FourthSocView
@synthesize webview;
 ...
 */
- (void)viewDidLoad {
    NSString *website = @"http://www.roxburylatin.org/school_life/athteampages.aspx?TeamID=693";
