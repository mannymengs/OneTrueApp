...
#import "JVWrestView.h"

@interface JVWrestView ()

@end

@implementation JVWrestView
@synthesize webview;
 ...
 */
- (void)viewDidLoad {
    NSString *website = @"http://www.roxburylatin.org/school_life/athteampages.aspx?TeamID=700";
