...
#import "JuniorFootView.h"

@interface JuniorFootView ()

@end

@implementation JuniorFootView
@synthesize webview;
 ...
 */
- (void)viewDidLoad {
    NSString *website = @"http://www.roxburylatin.org/school_life/athteampages.aspx?TeamID=682";
